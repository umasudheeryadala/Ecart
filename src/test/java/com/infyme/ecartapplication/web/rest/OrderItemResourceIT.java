...
class OrderItemResourceIT {
    ...
    private static final String DEFAULT_PRODUCT_NAME = "Tw Nyrr Pe Lkzg Hevihmn Ueu";
    private static final String UPDATED_PRODUCT_NAME = "Wj Bnsxskh Ez Zpftu";
    ...
    public static OrderItem createEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem().productName(DEFAULT_PRODUCT_NAME).quantity(DEFAULT_QUANTITY).price(DEFAULT_PRICE);
        return orderItem;
    }
    ...
    public static OrderItem createUpdatedEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem().productName(UPDATED_PRODUCT_NAME).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
        return orderItem;
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.productName(UPDATED_PRODUCT_NAME).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.productName(UPDATED_PRODUCT_NAME).price(UPDATED_PRICE);
    ...
    void fullUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.productName(UPDATED_PRODUCT_NAME).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
